...
Ethan Paek
Lab #3
Wednesday Sessions, February 7th, 2018
This function reads in the amount of unique and odd number of words in a text file through a hash table with void pointers
*/
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
